...
{
    public class CreateMatchRequestValidator : BaseFluentValidator<CreateMatchRequest>
    {
        public CreateMatchRequestValidator(IDefaultErrorCodeProvider defaultErrorCodeProvider) : base(defaultErrorCodeProvider)
        {
